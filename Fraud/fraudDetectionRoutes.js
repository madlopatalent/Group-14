...
const router = express.Router();  // i am out
const db = require('../db/database'); // this is missing Make sure this is the correct path to your database
const { checkFraud, fraudRules } = require("../FD Dashboard");
